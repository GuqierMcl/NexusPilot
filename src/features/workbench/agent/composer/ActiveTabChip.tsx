...
import type { ActiveTabContext } from "../../../../../shared/active-tab-context";
...
export const ActiveTabChip: FC<{ snapshot: ActiveTabContext; onRemove?: () => void; historical?: boolean }> = ({ snapshot, onRemove, historical }) => {
  ...
  const description = `本条消息携带标签页信息，未包含页面内容${state}`;
  return (
